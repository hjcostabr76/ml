...
function [weights, criteria, altweights, feedbackweights, combination] = ahp(M,C,varargin)
    %
    % Function taken from: https://www.mathworks.com/matlabcentral/fileexchange/79643-analytic-hierarchy-process
    % 22-01-14
    %
    ...
    %
    %   C:               An n-by-d matrix, where n of the pairwise comparison
    ...
    %                    higher the better), e.g. storage space or a battery痴 life expectancy.
    ...
    %                    be a k-by-r matrix, where k is the value a criterion for every option
    %                    and g is the number of criteria.
    %
